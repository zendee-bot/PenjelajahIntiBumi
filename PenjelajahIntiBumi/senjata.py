...
Tombak = Senjata(name="Tombak", senjata_tipe="Tidak Tajam", min_damage=8, max_damage=15, value=0)
TanganKosong = Senjata(name="Tangan Kosong", senjata_tipe="Tumpul", min_damage=3, max_damage=7, value=0)
...
Juruspambungkas = Senjata(name="Jurus Pambungkas", senjata_tipe="Keahlian", min_damage=30, max_damage=35, value=0)
